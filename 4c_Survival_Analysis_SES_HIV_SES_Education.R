...
### automate this later
strata_levels <- c("Mid", "Wealthiest", "25-39", "40-64", ">65", "Female", "Urban", "Peri-Urban", ">2-4", ">4-6", ">6")

#strata_levels <- c(">6",">4-6",">2-4","Peri-Urban","Urban","Feamle",">65","40-64","25-39","15-24","Wealthiest","Mid")
